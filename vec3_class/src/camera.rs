...
impl Camera {
    pub fn new(origin: Point3,lookat:Point3, aspect_ratio: f32, view_length: f64, screen_width: i32, distance: f64) -> Camera {
    ...
    pub fn default_new() -> Camera {
        Camera::new(Point3::new(0.0, 0.0, 0.0),Point3::new(0.0, 0.0, 1.0), 16.0 / 9.0, 2.0, 256, 1.0)
    }
